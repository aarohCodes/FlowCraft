  ...
  return (
    <>
      ...
      <motion.aside
        ...
        className={`
          fixed lg:sticky inset-y-0 left-0 z-40 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md 
          border-r border-gray-200/50 dark:border-gray-700/50 flex flex-col shadow-soft
          lg:translate-x-0 transition-transform duration-300 ease-in-out
          ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}
          lg:top-16 lg:h-[calc(100vh-4rem)] lg:max-h-[calc(100vh-4rem)] lg:overflow-y-auto scrollbar-thin
        `}
      ...
      >
        ...
        <div className="p-6 border-b border-gray-200/50 dark:border-gray-700/50 flex-shrink-0">
          ...
          <motion.button
            ...
            className={`w-full p-4 rounded-xl border-2 border-dashed transition-all duration-300 ${currentRoleConfig.bgColor} border-gray-300 dark:border-gray-600 hover:border-gray-400 dark:hover:border-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500`}
          >
              ...
              return (
                ...
                >
                  <motion.button
                    ...
                    className={`
                      w-full flex items-center space-x-4 px-4 py-3 rounded-xl text-left transition-all duration-300 relative group
                      ${isActive
                    ...
                    `}
                  >
                    {/* Enhanced Active Indicator with Spring Animation */}
                    {isActive && (
                      <motion.div
